...
@section('content')
    ...
    <div class="container"> <!-- at the beginning of .container -->
                ...
                <div class="row">
                    <div class="col-sm-12">
                                ...
                                <div class="col-sm-3">
                                    <div class="single-item">
                                        <div class="single-item-header">
                                            <!-- Using dd($new_product) to do very fast -->
                                            <a href="product.html"><img style="width: 320px; height: 220px;" src="source/image/product/{{ $item->image }}" alt=""></a>
                                        </div>
                        ...
                        <div class="beta-products-list">
                            ...
                            <div class="row">
                                @foreach($top_product as $_top_product)
                                <div class="col-sm-3">
                                    <div class="single-item">
                                        <div class="single-item-header">
                                            <a href="product.html"><img style="width: 320px; height: 220px;" src="source/image/product/{{ $_top_product->image }}" alt=""></a>
                                        </div>
                                        <div class="single-item-body">
                                            <p class="single-item-title"{{ $_top_product->name }}</p>
                                            @if($item->promotion_price == 0)
                                                <p class="single-item-price">
                                                    <span>{{ number_format($item->unit_price) }} VND</span>
                                                </p>
                                            @else
